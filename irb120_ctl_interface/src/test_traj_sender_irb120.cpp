...
int main(int argc, char** argv) 
{
    ...
    for (int i=0;i<3;i++) //send this twice, just to make sure have communication w/ subscriber
    {
     ...
     int numPublish = 0;
     double t = 0.0;
     while (numPublish < 200) {

       trajectory_point1.time_from_start = ros::Duration(t);
       trajectory_point2.time_from_start = ros::Duration(t + 0.5); 
       trajectory_point3.time_from_start = ros::Duration(t + 1); 
       trajectory_point4.time_from_start = ros::Duration(t + 1.5); 
       trajectory_point5.time_from_start = ros::Duration(t + 2);
       trajectory_point6.time_from_start = ros::Duration(t + 2.5); 
       new_trajectory.header.stamp = ros::Time::now();

       trajectory_point1.positions[0] = sin(omega * t);
       trajectory_point1.positions[1] =  cos(omega * t);
     
       trajectory_point2.positions[0] = sin(omega * t);
       trajectory_point2.positions[1] =  cos(omega * t);
     
       trajectory_point3.positions[0] = sin(omega * t);
       trajectory_point3.positions[1] =  cos(omega * t);
     
       trajectory_point4.positions[0] = sin(omega * t);
       trajectory_point4.positions[1] =  cos(omega * t);
     
       trajectory_point5.positions[0] = sin(omega * t);
       trajectory_point5.positions[1] =  cos(omega * t);
     
       trajectory_point6.positions[0] = sin(omega * t);
       trajectory_point6.positions[1] = cos(omega * t);  
